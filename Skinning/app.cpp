...
void App::Render(float aspectRatio) {
	glm::mat4 projection = glm::perspective(60.0f, aspectRatio, 0.01f, 1000.0f);
	...
	_vertexPositions->BindTo(_shader->GetAttributeIndex("normal"));
	_vertexPositions->BindTo(_shader->GetAttributeIndex("texCoord"));
